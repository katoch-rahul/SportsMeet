...
public class RegistrationBDM extends AppCompatActivity  {
FirebaseDatabase db;
...
ConstraintLayout l;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_bdm);
        sp=findViewById(R.id.register_bdm_spinn);
        db=FirebaseDatabase.getInstance();
        ttref=db.getReference();

        name=findViewById(R.id.register_bdm_name);
        sem=findViewById(R.id.register_bdm_sem);
        roll=findViewById(R.id.register_bdm_roll);
        phone=findViewById(R.id.register_bdm_phone);
        l=findViewById(R.id.register_bdm_layy);
        partner=findViewById(R.id.register_bdm_partner);
        spinnerChoice(sp);
    ...
    public void onClicka_bdm(View view)
    {
       ...
       String key=ref.child(game).child(cat).push().getKey();
        ref.child(game).child(cat).child(key).setValue(p)
            ...
            public void onFailure(@NonNull Exception e) {
                Snackbar sb0=Snackbar.make(l,name.getText().toString()+"Registration  Unsuccessful",
                        Snackbar.LENGTH_LONG );
                sb0.show();
            }
        });
