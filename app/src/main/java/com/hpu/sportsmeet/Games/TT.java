...
public class TT extends AppCompatActivity {
    ...
    {
        Query mSingle=ref.child("TableTennis").child("Men Single").orderByKey();
        ValueEventListener vel=new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot ) {
                ...
                {  p=myItem.getValue(Player.class);
                    men=findViewById(R.id.text_participants_men_single);
        ...
        Query womenSingle=ref.child("TableTennis").child("Women Single").orderByKey();
        ValueEventListener vel2=new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot ) {
                ...
                for(DataSnapshot myItem:dataSnapshot.getChildren())
                {  p=myItem.getValue(Player.class);
                    men=findViewById(R.id.text_participants_women_single);
        ...
        Query men2=ref.child("TableTennis").child("Men Double").orderByKey();
        ValueEventListener vel3=new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot ) {
                ...
                for(DataSnapshot myItem:dataSnapshot.getChildren())
                {  p=myItem.getValue(Player.class);
                    men=findViewById(R.id.text_participants_men_double);
        ...
        Query women2=ref.child("TableTennis").child("Women Double").orderByKey();
        ValueEventListener vel4=new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot ) {
                ...
                for(DataSnapshot myItem:dataSnapshot.getChildren())
                {  p=myItem.getValue(Player.class);
                    men=findViewById(R.id.text_participants_women_double);
       ...
       women2.addValueEventListener(vel4);
        ...
        Query mix=ref.child("TableTennis").child("Mix Double").orderByKey();
        ValueEventListener vel5=new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot ) {
                ...
                for(DataSnapshot myItem:dataSnapshot.getChildren())
                {  p=myItem.getValue(Player.class);
                    men=findViewById(R.id.text_participants_mix);
